...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
            <a class="navbar-brand" href="#">BookBookId</a>
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Untuk <span> anda </span>yang <br> <span>lapar</span> akan <span>buku</span></h1>
    ...
    <div class="container about">
        ...
        <div class="row about">
            ...
            <div class="col-lg-5">
                <h3><span>WE</span> WILL PROVIDE <span>YOU</span> WITH <span>INFORMATION</span> ABOUT <span>BOOKS</span></h3>
                <p>Even though right now, it's just a book information. But we will surely update in the future cause maybe you're one of us as well. This site is open for everyone to add more and more information about all the books around the world. Click the button below to register and become our partners in crime.</p>
        ...
        <div class="row footer">
            <div class="col text-center">
                <p>2023 All Rights Reserved by Tresna Eka Widiana.</p>
            </div>
        </div>
        <!-- Akhir Footer -->
    </div>
